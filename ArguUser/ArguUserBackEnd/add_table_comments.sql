...
ALTER TABLE users MODIFY COLUMN username VARCHAR(50) NOT NULL UNIQUE COMMENT '사용자명 (고유값)';
...
-- argu 테이블 주석
ALTER TABLE argu COMMENT = '논쟁 주제 테이블';
ALTER TABLE argu MODIFY COLUMN id BIGINT AUTO_INCREMENT COMMENT '논쟁 ID';
ALTER TABLE argu MODIFY COLUMN user_id BIGINT NOT NULL COMMENT '논쟁 작성자 ID';
ALTER TABLE argu MODIFY COLUMN category_id BIGINT NOT NULL COMMENT '카테고리 ID';
ALTER TABLE argu MODIFY COLUMN title VARCHAR(255) NOT NULL COMMENT '논쟁 제목';
ALTER TABLE argu MODIFY COLUMN content TEXT NOT NULL COMMENT '논쟁 내용';
ALTER TABLE argu MODIFY COLUMN start_date DATETIME(6) NOT NULL COMMENT '논쟁 시작 일시';
ALTER TABLE argu MODIFY COLUMN end_date DATETIME(6) NOT NULL COMMENT '논쟁 종료 일시';
ALTER TABLE argu MODIFY COLUMN status VARCHAR(255) NOT NULL COMMENT '논쟁 상태 (SCHEDULED: 예정, ACTIVE: 진행중, ENDED: 종료)';
ALTER TABLE argu MODIFY COLUMN is_hidden BOOLEAN NOT NULL COMMENT '숨김 여부';
ALTER TABLE argu MODIFY COLUMN view_count INT NOT NULL COMMENT '조회수';
ALTER TABLE argu MODIFY COLUMN created_at DATETIME(6) NOT NULL COMMENT '생성 일시';
ALTER TABLE argu MODIFY COLUMN updated_at DATETIME(6) NOT NULL COMMENT '수정 일시';
...
ALTER TABLE comments MODIFY COLUMN argu_id BIGINT NOT NULL COMMENT '논쟁 ID';
...
-- argu_opinion 테이블 주석
ALTER TABLE argu_opinion COMMENT = '논쟁 의견 테이블';
ALTER TABLE argu_opinion MODIFY COLUMN id BIGINT AUTO_INCREMENT COMMENT '의견 ID';
ALTER TABLE argu_opinion MODIFY COLUMN argu_id BIGINT NOT NULL COMMENT '논쟁 ID';
ALTER TABLE argu_opinion MODIFY COLUMN user_id BIGINT NOT NULL COMMENT '사용자 ID';
ALTER TABLE argu_opinion MODIFY COLUMN side VARCHAR(20) NOT NULL COMMENT '입장 (FOR: 찬성, AGAINST: 반대, NEUTRAL: 중립, OTHER: 기타)';
ALTER TABLE argu_opinion MODIFY COLUMN content TEXT COMMENT '의견 내용';
ALTER TABLE argu_opinion MODIFY COLUMN created_at DATETIME(6) NOT NULL COMMENT '생성 일시';
ALTER TABLE argu_opinion MODIFY COLUMN updated_at DATETIME(6) NOT NULL COMMENT '수정 일시';

-- bookmarks 테이블 주석
ALTER TABLE bookmarks COMMENT = '북마크 테이블';
ALTER TABLE bookmarks MODIFY COLUMN id BIGINT AUTO_INCREMENT COMMENT '북마크 ID';
ALTER TABLE bookmarks MODIFY COLUMN argu_id BIGINT NOT NULL COMMENT '논쟁 ID';
...
ALTER TABLE likes MODIFY COLUMN argu_id BIGINT NOT NULL COMMENT '논쟁 ID';
...
ALTER TABLE reports MODIFY COLUMN target_type VARCHAR(20) NOT NULL COMMENT '신고 대상 타입 (ARGU: 논쟁, COMMENT: 댓글, USER: 사용자)';
...
ALTER TABLE chat_messages MODIFY COLUMN argu_id BIGINT NOT NULL COMMENT '논쟁 ID';
